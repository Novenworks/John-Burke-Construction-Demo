# Project router (John Burke Construction demo)

This workspace is a **Novenworks speculative redesign** of johnburkeconstruction.com.
The prospect is not a client. Sandbox contract continues below.

Canonical project docs:

- [AGENTS.project.md](AGENTS.project.md) — product rules for later agents
- [README.md](README.md) — disclosure and setup
- [docs/RESEARCH.md](docs/RESEARCH.md) — facts, CSLB, agency check
- [docs/ASSET-INVENTORY.md](docs/ASSET-INVENTORY.md)
- [docs/ASSET-PLAN.md](docs/ASSET-PLAN.md)
